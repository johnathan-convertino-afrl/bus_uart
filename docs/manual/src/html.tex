...
\begin{document}
  ...
  \subsection{\href{../files/axi_lite_uart_lite-v.html}{axi\_lite\_uart\_lite}}

  \subsection{\href{../files/wishbone_standard_uart_lite-v.html}{wishbone\_standard\_uart\_lite}}

  \subsection{\href{../files/up_uart_lite-v.html}{up\_uart\_lite}}
